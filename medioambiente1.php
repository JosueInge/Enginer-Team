<?php
$categoria_actual = 'medio ambiente';
...
$sql_total = "SELECT COUNT(*) as total FROM (
              ...
              WHERE categoria = 'medio ambiente' AND fecha <= CURDATE()
              UNION ALL
              SELECT id FROM propuestas_noticias
              WHERE categoria = 'medio ambiente' AND estado = 'aprobada' AND fecha <= CURDATE()
          ) as combined";
$result_total = $conexion->query($sql_total);
$total_noticias = $result_total->fetch_assoc()['total'];
$total_paginas = ceil($total_noticias / $noticias_por_pagina);

// Obtener noticias de la categoria medio ambiente combinando noticias y propuestas noticias 
...
<div class="container-fluid">
  <!-- Encabezado categoria -->
   <div class="encabezado-categoria">
      <h1 class="titulo-categoria">Todo sobre el medio ambiente</h1>
