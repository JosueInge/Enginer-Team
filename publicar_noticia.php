      ...
      error_log("DEBUG SQL: Categoria=$categoria, Titulo=$titulo, Descripcion=$descripcion, Imagen0={$imagenes_nombres[0]}, Imagen1={$imagenes_nombres[1]}, Imagen2={$imagenes_nombres[2]}, Fecha=$fecha_evento, Bloquear_comentarios{$bloquear_comentarios}");
        ...
        if ($stmt->execute()) {
            $mensajeToast = "Tu noticia fue publicada con exito!";
                ...
                $mensajeToast = "Error al publicar la noticia: " . $conexion->error;
                $tipoToast = "danger";
...
<body>
  ...
  <div class="contenedor-principal">
    <h1 class="tituloPrincipal" >Publicar Nueva Noticia</h1>
  ...
  <div id="modalConfirmarEnvio" class="modal-overlay">
    <div class="modal-contenido">
      <h2 style="font-family: 'Poppins', sans-serif; font-size:16px; color:#403F48; font-weight:bold; text-align:center;">
        ¿Estás seguro de publicar tu noticia?
      </h2>
      <p style="font-family: 'Inter', sans-serif; font-size:16px; color:#403F48; text-align:center; margin-top:10px;">
        Estas apunto de publicar tu noticia. Una vez publicada, estará disponible para todos los lectores.
      </p>
