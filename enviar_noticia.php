...
<body>
  <header>
    ...
    <h3><a class="volverNoticias" href="noticias.php">Volver a Noticias</a></h3>
  </header>

  <div class="contenedor-principal">
    <h1 class="tituloPrincipal" >Enviar Nueva Noticia</h1>

    <p class="Subtítuloinformativo">Tu noticia será revisada por los administradores antes de su publicación.</p>

    <form id="formNoticia" action="enviar_noticia.php" method="POST" enctype="multipart/form-data" novalidate>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const linkVolver = document.querySelector(".volverNoticias");
  ...
  <div id="modalConfirmarEnvio" class="modal-overlay">
    <div class="modal-contenido">
      <h2 style="font-family: 'Poppins', sans-serif; font-size:16px; color:#403F48; font-weight:bold; text-align:center;">
        ¿Estás seguro de enviar tu noticia?
      </h2>
      <p style="font-family: 'Inter', sans-serif; font-size:16px; color:#403F48; text-align:center; margin-top:10px;">
        Esta acción enviará tu noticia para que los administradores puedan revisarla.
      </p>
