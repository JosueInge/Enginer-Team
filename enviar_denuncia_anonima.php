...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validar que no estén vacíos después de quitar espacios
    if ($titulo === '' || $descripcion === '') {
        guardarLog("Error campos vacios al enviar los datos.");
    } else {
        $imagen_nombre = null;
        if (isset($_FILES['imagen']) && $_FILES['imagen']['error'] === UPLOAD_ERR_OK) {
            ...
            if ($mime !== 'image/jpeg' || ($extension !== 'jpg' && $extension !== 'jpeg')) {
                $errorimagen = "Solo se permiten imágenes en formato JPEG.";
        ...
        // Guardar en la BD solo si no hay errores de imagen
...
<header>
        ...
        <nav class="informacion">
            <a href="denuncia_anonima.php" class="volver" >Volver a Denuncias</a>
        </nav>
    </header>
