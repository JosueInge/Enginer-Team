...
// Si es una petición AJAX, devolver solo el HTML de las nuevas noticias
...
<?php
    endwhile;
    exit; // Terminar ejecución para peticiones AJAX
}
?>
...
<div class="container-fluid">
  ...
  <div class="contenedor-principal">
    ...
    <div class="anuncio-lateral">
      <a href="detalle_anuncio.php?id=1" target="_blank">
        <?php
