...
// Comentamos temporalmente la verificación de la clase
...
try {
    ...
    die("Error: La biblioteca de Azure no está instalada correctamente. Ejecuta: composer require thenetworg/oauth2-azure");
}
?>